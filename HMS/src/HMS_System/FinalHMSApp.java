...
public class FinalHMSApp {
        ...
        while (true) {
            ...
            switch (categoryChoice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    manageAppointments(appointmentDatabase, scanner);
                    break;
                case 4:
    ...
    private static void manageAppointments(AppointmentDatabase appointmentDatabase, Scanner scanner) {
        while (true) {
            System.out.println("Enter your choice:");
            ...
            try {
                switch (choice) {
                    case 1:
                        ...
                        String appointmentDateTimeStr = scanner.nextLine() + ":00";
                        ...
                        appointmentDatabase.addAppointment(newAppointment);
                        break;
                    ...
                    case 2:
                        ...
                        for (Appointment appointment : appointments) {
                            System.out.println("Patient ID: " + appointment.getPatientId() +
                                               ...
                                               ", Appointment Date & Time: " + appointment.getFormattedAppointmentDateTime() +
                    ...
                    case 3:
                        ...
                        System.out.println("Enter new patient ID (if there is any change):");
                        int updatePatientId = scanner.nextInt();
                        scanner.nextLine();

                        System.out.println("Enter new doctor ID (if there is any change):");
                        int updateDoctorId = scanner.nextInt();
                        scanner.nextLine();

                        System.out.println("Enter new appointment date and time (yyyy-MM-dd HH:mm) (if there is any change):");
                        String updateAppointmentDateTimeStr = scanner.nextLine() + ":00";
                        Timestamp updateAppointmentDateTime = Timestamp.valueOf(updateAppointmentDateTimeStr);

                        System.out.println("Enter new reason for appointment (if there is any change):");
                        String updateReason = scanner.nextLine();

                        Appointment updatedAppointment = new Appointment(updatePatientId, updateDoctorId, updateAppointmentDateTime, updateReason);
                        appointmentDatabase.updateAppointment(updateId, updatedAppointment);
                        break;
                    ...
                    case 4:
                        ...
                        appointmentDatabase.deleteAppointment(deleteId);
                        break;
            ...
            try {
                switch (choice) {
                    case 1:
                        ...
                        System.out.println("Enter staff's contact number:");
                        String contactNumber = scanner.nextLine();
                    ...
                    case 3:
                        ...
                        System.out.println("Enter new staff name (if there is any change):");
                        String updateName = scanner.nextLine();

                        System.out.println("Enter new staff contact number (if there is any change):");
                        String updateContactNumber = scanner.nextLine();

                        Staff updatedStaff = new Staff(updateName, updateContactNumber);
                        staffDatabase.updateStaff(updateId, updatedStaff);
                        break;
                    ...
                    case 4:
                        ...
                        staffDatabase.deleteStaff(deleteId);
                        break;
