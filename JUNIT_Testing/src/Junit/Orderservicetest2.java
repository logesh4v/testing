...
//Parameterized test - @CsvSource, @ValueSource, @MethodSource
	    ...
	    static Stream<Arguments> testValidInputs(){
			return Stream.of(
					org.junit.jupiter.params.provider.Arguments.of(100.00,2,180),
					org.junit.jupiter.params.provider.Arguments.of(100.00,3,270),
					org.junit.jupiter.params.provider.Arguments.of(100.00,4,360)
);
		}
